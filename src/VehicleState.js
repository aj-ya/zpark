...
function ReturnVehicle(){
    ...
    const vehicle = location.state?location.state.vehicle:{Name:'Dummy',Charge:20,charging:false};
    return vehicle;
}
function VehicleCard(){
        ...
        return(
            <div className='vehicle-card'>
                ...
                <div class='op-score'>Operational Score: <span id="charge-perc">{vehicleObj.Charge}%</span></div>
...
export default class VehicleState extends React.Component{
    componentDidMount(){
        ...
        if (window.matchMedia('screen and (max-width: 768px)').matches) {img_src=img_src+'-mobile'}
